...
if($query_exclui) {
	...
	echo "<script>";
	echo "open('gerenciar.php?aviso=ok&msg=Proximidade excluída com sucesso.','_self');";
	echo "</script>";
} else {
	// Log
	...
	echo "<script>";
	echo "open('gerenciar.php?aviso=erro&msg=Não foi possível exclui a proximidade.','_self');";
	echo "</script>";
}
?>