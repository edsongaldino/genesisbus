...
<body>
<div class="titulo-sessao-azul">Depoimentos</div>
...
<form id="form1" name="form1" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>?acao=consultar" enctype="multipart/form-data" onsubmit="javascript: this.button.value='Aguarde, carregando...'; this.button.disabled='disabled';">
  <tr>
    <td><input type="button" name="button" id="button" onclick="javascript: window.open('incluir_diferencial.php','_self');" value="Incluir novo depoimento" /></td>
  </tr>
  <tr>
    <td>
          ...
          <div class="TabbedPanelsContent">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><input type="submit" name="button" id="button" value="Filtrar diferencial" /></td>
              </tr>
            </table>
          </div>
        </div>
    ...
    <td>
        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr bgcolor="<?php if(is_int($i/2) != 1) { echo "#EDEFF3"; } else { echo "#FFFFFF"; }; ?>">
            ...
            <td><div align="center"><a href="alterar_diferencial.php?id_diferencial=<?php echo base64_encode($executa_diferencial['id_diferencial']); ?>" target="_self"><img src="../imagens/icone/icone_alterar.png" title="Alterar a diferencial" width="16" height="16" border="0" /></a></div></td>
