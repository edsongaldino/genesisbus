...
// Coleta os dados
$sql_usuarios = "SELECT id_usuario AS id_user, nome, login, DATE_FORMAT(ultimo_acesso,'%d/%m/%Y %H:%i:%s') AS ultimo_acesso, status FROM sistema_usuarios WHERE status <> 'E'".$condicao_consulta." ORDER BY id_user DESC";
...
<body>
<div class="titulo-sessao-azul">Usu&aacute;rios</div>
  ...
  <tr>
    <td>
        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <?php while($executa_usuarios = mysql_fetch_assoc($query_usuarios)) { ?>
          <tr bgcolor="<?php if(is_int($i/2) != 1) { echo "#EDEFF3"; } else { echo "#FFFFFF"; }; ?>">
            ...
            <td><div align="center"><?php echo $executa_usuarios['id_user']; ?></div></td>
            <td><?php echo $executa_usuarios['nome']; ?></td>
            <td><?php echo $executa_usuarios['login']; ?></td>
            <td><?php echo $executa_usuarios['ultimo_acesso']; ?></td>
            <td><div align="center"><a href="alterar_usuario.php?id_user=<?php echo base64_encode($executa_usuarios['id_user']); ?>" target="_self"><img src="../imagens/icone/icone_alterar.png" title="Alterar o usu&aacute;rio" width="16" height="16" border="0" /></a></div></td>
            <td><div align="center"><a href="javascript: confirma_acao('Tem certeza que deseja excluir &quot;<?php echo $executa_usuarios['nome']; ?>&quot;?','excluir_usuario.php?id_user=<?php echo base64_encode($executa_usuarios['id_user']); ?>');" target="_self"><img src="../imagens/icone/icone_excluir.gif" title="Excluir o usu&aacute;rio" width="16" height="16" border="0" /></a></div></td>
          </tr>
          <?php $i += 1; } ?>
        </table>
    </td>
