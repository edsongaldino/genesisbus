...
// Pega o id
$id_galeria = base64_decode(addslashes(trim($_GET['id_galeria'])));
?>
...
<body>
<div class="titulo-sessao-azul">Incluir fotos da galeria</div>
<?php include("../sistema_aviso.php"); ?>
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
<form id="form1" name="form1" method="post" action="incluir_galeria_fotos_destaque.php?id_galeria=<?php echo base64_encode($id_galeria); ?>">
  <tr>
    <td colspan="2">
      <div id="incluir_galeria_foto" class="TabbedPanels">
        <ul class="TabbedPanelsTabGroup">
          <li class="TabbedPanelsTab" tabindex="0">Fotos da galeria</li>
        </ul>
              ...
              <tr>
                ...
                $(document).ready(function() {
                    $("#fileInput2").uploadify({
                        ...
                        'folder'         : '../../conteudos/galeria/<?php echo $id_galeria; ?>/temp/',
  ...
  <tr>
    <td>
    	<div class="info-observacao">
        	Ap&oacute;s adicionar todas as fotos e realizar o envio, clique em <span class="negrito">Finalizar postagem de fotos</span> para selecionar as fotos em destaque do galeria.<br />
...
<script type="text/javascript">
var incluir_galeria_foto = new Spry.Widget.TabbedPanels("incluir_galeria_foto");
</script>
</body>
</html>