...
// Diretorios padrao
$diretorio_raiz_absoluto = "/public_html/conteudos/galeria/".$id_galeria."/";
...
if($_GET['acao'] == "alterar") {
  ...
  $atualiza_foto->execute();
	...
	if($erro == false) {
		echo "<script>";
		echo "open('".$_SERVER['SCRIPT_NAME']."?aviso=ok&msg=Informações das fotos salva com sucesso.&id_galeria=".base64_encode($id_galeria)."','_self');";
		echo "</script>";
	} else {
		echo "<script>";
		echo "open('".$_SERVER['SCRIPT_NAME']."?aviso=erro&msg=Não foi poss?vel salvar todas as informa??es das fotos.&id_galeria=".base64_encode($id_galeria)."','_self');";
		echo "</script>";
	}
}
        ...
        <div class="TabbedPanelsContentGroup">
          <div class="TabbedPanelsContent">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><a href="/painel/ferramentas/Upload-Jquery/index.php?origem=galeria&id=<?php echo $id_galeria; ?>" target="_self"><img src="../imagens/painel/botao_adicionarmaisfoto.gif" title="Adicionar mais foto" width="170" height="30" border="0" /></a></td>
              </tr>
              <tr>
                <td>
